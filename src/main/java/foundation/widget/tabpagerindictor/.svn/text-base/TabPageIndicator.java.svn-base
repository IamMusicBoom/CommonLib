...
public class TabPageIndicator extends HorizontalScrollView {
    ...
    private int underlineColor = 0x00dcdcdc;// 默认指示线的颜色
    ...
    public void setUnSelectedColor(int unSelectedColor) {
        this.tabTextColor = unSelectedColor;
    }
...
//    = R.drawable.background_tab;//字体颜色的选择器
    ...
    //文字的style  是 默认横线 还是 包裹
    public TabPageStyle currentStyle = TabPageStyle.LINE;
...
//        isSameLine = a.getBoolean(R.styleable.PagerSlidingTab_sameLine, isSameLine);
        ...
        currentStyle = a.getInteger(R.styleable.PagerSlidingTab_tabPageStyle, 0) == 0 ? TabPageStyle.LINE : TabPageStyle.PACKAGE;
        a.recycle();
    ...
    private void addTextTab(final int position, String title) {
        ...
        tab.setSingleLine();
        if (currentStyle == TabPageStyle.PACKAGE) {
            tab.setTextColor(position == 0 ? getResources().getColor(R.color.white) :
                    tabTextColorSelected);
            tab.setBackgroundResource(position == 0 ? R.drawable.baby_check_on : R.drawable.baby_check_out);
        } else
        ...
        public void onPageSelected(int position) {
            ...
            for (int i = 0; i < tabCount; i++) {
                ...
                if (v instanceof TextView) {
                    ...
                    textView.setTextColor(i == pager.getCurrentItem() ?
                            tabTextColorSelected : tabTextColor);
                    if (currentStyle == TabPageStyle.PACKAGE)
                        textView.setBackgroundResource(i == pager.getCurrentItem() ?
                                R.drawable.baby_check_on : R.drawable.baby_check_out
                        );
                }
            }
        }
